...
export default function PlayerCard({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-black/30 via-black/15 to-orange-950/15 p-3 shadow-2xl shadow-black/35 backdrop-blur-md lg:rounded-[2rem] lg:p-7">
