...
export default function PlayerCard({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-black/35 via-black/20 to-orange-950/20 p-3 shadow-2xl shadow-black/35 backdrop-blur-[6px] lg:rounded-[2rem] lg:p-7">
